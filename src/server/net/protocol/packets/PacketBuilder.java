...
public class PacketBuilder extends Packet {
	 ...
	 */
	public PacketBuilder createFrame(int opcode, ISAACCipher encryption) {
		putByte(opcode + encryption.getNextValue()).opcode(opcode);
		return this;
	}
	 ...
	 * 
	 * @param encryption
	 *            the ISAACCipher encryption
	 */
	public PacketBuilder createSizedFrame(int opcode, ISAACCipher encryption) {
	 ...
	 *            the ISAACCipher encryption
	 */
	public PacketBuilder createShortSizedFrame(int opcode, ISAACCipher encryption) {
